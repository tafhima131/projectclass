...
class ClassAdapter extends RecyclerView.Adapter<ClassAdapter.ClassViewHolder> {
    ...
    public interface OnNextBtnClickListener {
        void onNextBtnClick(int position);
    }

    public void setOnNextBtnClickListener(OnNextBtnClickListener listener) {
        this.onNextBtnClickListener = listener;
    }
    ...
    public static class ClassViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        public ClassViewHolder(@NonNull View itemView, OnNextBtnClickListener onNextBtnClickListener) {
            super(itemView);
            ...
            nextBtn.setOnClickListener(v -> {
                if (onNextBtnClickListener != null) {
                    onNextBtnClickListener.onNextBtnClick(getAdapterPosition());
                }
            });
        }
    ...
    public ClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ClassViewHolder(itemView, onNextBtnClickListener);
    }
